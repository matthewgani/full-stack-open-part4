...
describe('invalid users are not created', () => {
  ...
  test('with less than 3 character password', async() => {
    ...
    // send object instead of new User object. new User object needs passwordhash
    // so we cannot set it directly. we need to send normal object through the api route
